...
class greenfun:
    ...
    def finish(top):
        ...
        path = 'C:/Politeness/picture_arabic/Finish.jpg'
    ...
    def GreenGUI():
        ...
        path = 'C:/Politeness/picture_arabic/Task_impolite.jpg'
        img = ImageTk.PhotoImage(Image.open(path))
        msg = Label(root, image=img)
        msg.image = img
        msg.pack()
...
class redfun:
    def finish(top):
        ...
        root = Toplevel()
        root.geometry('1920x1080')
        path = 'C:/Politeness/picture_arabic/Finish_polite.jpg'
        img = ImageTk.PhotoImage(Image.open(path))
        msg = Label(root, image=img)
        msg.image = img
        msg.pack(side='right')
    ...
    def redtask(top,choice,count,bk,o,wh,gr,ye,pu,scenario):
        ...
        root = tk.Toplevel()
        root.geometry('1920x1080')
        path = 'C:/Politeness/picture_arabic/Task.jpg'
        img = ImageTk.PhotoImage(Image.open(path))
        msg = Label(root, image=img)
        msg.image = img
        msg.pack()
    ...
    def redtimeGUI(top,count,bk,o,wh,gr,ye,pu,scenario):
        ...
        if (count>6):
            ...
            root.geometry('1920x1080')
            root.config(bg='azure')
            path = 'C:/Politeness/picture_arabic/Option_button.jpg'
            img = ImageTk.PhotoImage(Image.open(path))
    ...
    def redstart(tp,scenario):
        ...
        root.config(bg='azure')
        root.geometry('1920x1080')
        path = 'c:/Politeness/picture_arabic/Welcome.jpg'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel = Label(root, image=img)
        pannel.image = img
        pannel.pack()
...
class blankscreen:
    def blnkscr():
        ...
        obj_red = redfun
        green_low_polite = tk.Button(root, padx=1.0, pady=1.0, height=4, width=8, bg='skyblue', text='شمال',
                                     font=('times', 32, 'bold'), command=lambda: obj_green.Greenlevel(root,1))
        left_middle=tk.Button(root, padx=1.0, pady=1.0, height=4, width=8, bg='skyblue', text='شمال\n وسط',
                                     font=('times', 32, 'bold'), command=lambda: obj_green.Greenlevel(root,2))
        right_middle=tk.Button(root, padx=1.0, pady=1.0, height=4, width=8, bg='skyblue', text='يمين \n وسط',
                                     font=('times', 32, 'bold'), command=lambda: obj_red.redstart(root,1))

        red_medium_polite = tk.Button(root, height=4, width=8, bg='skyblue', text='يمين', font=('times', 32, 'bold'),
