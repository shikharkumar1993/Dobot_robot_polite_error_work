...
class greenfun:
    ...
    def finish(top):
        ...
        path='C:\Politeness\Picture\Finish.png'
    ...
    def GreenGUI():
         ...
         path='C:\Politeness\Picture\settingtable.png'
         img = ImageTk.PhotoImage(Image.open(path))
         msg=Label(root,image=img)
         msg.image=img
         msg.pack()
    ...
    def removeGUI():
         ...
         root.geometry('1920x1080')
         root.config(bg='azure')
         path='C:\Politeness\Picture/removeutensil.png'
         img = ImageTk.PhotoImage(Image.open(path))
         msg=Label(root,image=img)
         msg.image=img
         msg.pack()
    ...
    def waitremove():
        ...
        while(countdown!=-1):
            ...
            if (countdown==0):
                ...
                label.configure(bg='azure',text="Removing the utensils in : %d seconds" %countdown,font=('times',60,'bold'))
                label.pack()
                root.update() 
                time.sleep(1)
                countdown=countdown-1                
...
class bluefun:
    ...
    def blue_timer(top):
        ...
        while(countdown!=-1):
            ...
            if (countdown==0):
                ...
                label.configure(bg='azure',text="Time left: %d seconds" %countdown,font=('times',60,'bold'))
                label.pack()
                root.update() 
                time.sleep(1)
                countdown=countdown-1                
    ...
    def blue_set_table(top):
        ...
        path='c:/Politeness/Picture/blueremove.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
        opt_yes=tk.Button(root,padx=1.0,pady=1.0,height=2,width=25,bg='white',text='Yes',font=('times',34,'bold'))
        opt_yes.config(command= lambda button=opt_yes :obj_blu.blue_remove(root))
        opt_no=tk.Button(root,padx=1.0,pady=1.0,height=2,width=25,bg='white',text='No',font=('times',34,'bold'))
    ...
    def Bluestart(tp):
        ...
        root.geometry('1920x1080')
        root.config(bg='azure')
        path='c:/Politeness/Picture/bluequestion.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
        ...
        opt_no=tk.Button(root,padx=1.0,pady=1.0,height=2,width=25,bg='white',text='Not yet',font=('times',34,'bold'),command=lambda: obj.blue_timer(root))
        #msg1.grid()
        #opt_yes.grid()
        #opt_no.grid()
        #msg1.place(relx=0.1,rely=0,anchor=NW)
...
class redfun:
    ...
    def fancysetting():
         ...
         root.geometry('1920x1080')
         root.config(bg='azure')
         path=r'c:\Politeness\Picture\fancysetting.png'
         img = ImageTk.PhotoImage(Image.open(path))
         msg=Label(root,image=img)
         msg.image=img
         msg.pack()
    ...
    def red_timer(top,a):
        ...
        while(countdown!=-1):
            ...
            if (countdown==0):
                ...
                label.configure(text="Time left: %d seconds" %countdown,bg='azure',font=('times',40))
                label.pack()
                root.update()                
                close_but=tk.Button(root,bg='white',height=2,width=45,text="Set the table now",font=('times',34,'bold'),command=lambda: obj_red.redmeal(root))
                close_but.pack()
    ...
    def finish(top):
        ...
        #pannel=Label(root,image=img)
        #pannel.image=img
        msg=Label(root,text="Thank You Very Much",bg='azure')
    ...
    def red_set_table(top,a):
        ...
        path='C:/Politeness/Picture/feedback.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
        path1='C:/Politeness/Picture/Yes.jpg'
        if (a==1):
            path2='C:/Politeness/Picture/feedback_fancy.jpg'
        else:
            path2='C:/Politeness/Picture/feedback_regular.jpg'        
    ...
    def redmeal(top):
        ...
        obj_red.destroy_window(top)
        root.config(bg='azure')
        path='c:/Politeness/Picture/red meal.png'
        path1='c:/Politeness/Picture/setTable.jpg'
        path2='c:/Politeness/Picture/image002.jpg'
        path3='c:/Politeness/Picture/indifferent.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
    ...
    def redtimeGUI(top):
        ...
        root.geometry('1920x1080')
        root.config(bg='azure')
        path='C:/Politeness/Picture/redtime.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
        #msg1=Label(root,text="When do you want me to \n setup the table ?",bg='azure',font=('times',80,'bold'))               
        opt_yes=tk.Button(root,padx=1.0,pady=1.0,height=2,width=25,bg='white',text='Now',command=lambda:obj.redmeal(root),font=('times',34,'bold'))
        opt_onemi=tk.Button(root,padx=1.0,pady=1.0,height=2,width=25,bg='white',text='Later',command=lambda: obj.red_timer(root,1),font=('times',34,'bold'))
    ...
    def redstart(tp):
        ...
        root.config(bg='azure')
        root.geometry('1920x1080')
        path='c:/Politeness/Picture/Welcome.png'
        img = ImageTk.PhotoImage(Image.open(path))
        pannel=Label(root,image=img)
        pannel.image=img
        pannel.pack()
...
class MoveRobot:
    def fancysetting():
        ...
        if (state == dType.DobotConnect.DobotConnect_NoError):
            ...
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,-122.7399,-187.0418,66.9551,30.6419, 1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, -122.7399,-187.0418,44.9551,30.6419, 1)
            enableCtrl = 1
            dType.SetEndEffectorSuctionCup(api, enableCtrl,  1, isQueued=1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,-122.7399,-187.0418,66.9551,30.6419, 1)
            ...
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,145.7806,181.7918, 44.0901, 30.6419, 1)
            dType.SetEndEffectorSuctionCup(api, enableCtrl, 0, isQueued=1)
    ...
    def removefancy():
        ...
        if (state == dType.DobotConnect.DobotConnect_NoError):
            ...
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,145.7806,181.7918, 43.0901, 30.9651, 1)
            dType.SetEndEffectorSuctionCup(api, enableCtrl, 1, isQueued=1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,145.7806,181.7918, 67.6431, 30.9651, 1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, 223.4960, -0.2065, 66.0835, 30.6419, 1)
            ...
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode,-122.7399,-187.0418,66.9551,30.6419, 1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, -122.7399,-187.0418,43.9551,30.6419, 1)
            enableCtrl = 1
            dType.SetEndEffectorSuctionCup(api, enableCtrl,  0, isQueued=1)
            dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, -122.7399,-187.0418,66.9551,30.6419, 1)
...
class blankscreen:
    def blnkscr():
        ...
        obj_blue=bluefun
        obj_red=redfun
        green_low_polite=tk.Button(root,padx=1.0,pady=1.0,height=4,width=8,bg='aquamarine',text='Green',font=('times',32,'bold'),command=lambda :obj_green.Greenlevel(root))
        blue_medium_polite=tk.Button(root,height=4,width=8,bg='skyblue',text='Blue',font=('times',32,'bold'),command=lambda :obj_blue.Bluestart(root))
        red_medium_polite=tk.Button(root,height=4,width=8,bg='plum1',text='Purple',font=('times',32,'bold'),command=lambda :obj_red.redstart(root))
